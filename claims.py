...
def display_dashboard(username):
    ...
    tab_titles = ["Home", "Overview", "Claims Analysis"]
    ...
    st.markdown(
        ...
        [data-baseweb="tab"].css-1n76uvr.e16nr0pnh2 { 
            background-color: #004d99; /* Blue background for active tab */
            color: white;
        ...
        [data-baseweb="tab"]:hover {
            background-color: #b33900; /* Darker orange on hover */
            cursor: pointer;
        }
